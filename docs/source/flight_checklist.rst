...
Google Group in order to view and add the calendar to your own Google Calendar. Email 'Craig Woosley <cwoolsey@vt.edu/>`_ Add the KEAS Lab calendar to your account using the "+Google Calendar" 
